...
const resendEmail = async () => {
  ...
  try {
    await authService().sendAccountConfirmEmail({
      body: {
        email: props.email
      }
    })
...
<template>
  <div class="flex flex-col items-stretch gap-8 bg-zinc-50 p-6 shadow-layer">
    ...
    <div class="flex flex-col gap-2">
      <p>
        We have sent a confirmation letter to this e-mail address:
      </p>
